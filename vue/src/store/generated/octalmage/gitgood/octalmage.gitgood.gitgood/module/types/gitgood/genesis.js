...
const baseGenesisState = { achievementCount: 0, goalCount: 0, statCount: 0, teamCount: 0 };
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 7:
                    ...
                    break;
                case 8:
                    message.achievementCount = longToNumber(reader.uint64());
                    break;
                case 5:
                    message.goalList.push(Goal.decode(reader, reader.uint32()));
                    break;
                case 6:
                    message.goalCount = longToNumber(reader.uint64());
                    break;
                case 3:
