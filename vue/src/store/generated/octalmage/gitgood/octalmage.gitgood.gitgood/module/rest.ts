...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryGoalAll = (
    ...
    this.request<GitgoodQueryAllGoalResponse, RpcStatus>({
   ...
   */
  queryGoal = (id: string, params: RequestParams = {}) =>
    this.request<GitgoodQueryGetGoalResponse, RpcStatus>({
  ...
  queryTeamAll = (
    ...
    this.request<GitgoodQueryAllTeamResponse, RpcStatus>({
   ...
   */
  queryTeam = (id: string, params: RequestParams = {}) =>
    this.request<GitgoodQueryGetTeamResponse, RpcStatus>({
